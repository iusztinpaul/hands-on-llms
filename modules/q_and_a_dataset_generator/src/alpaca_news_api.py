...
try:
    ...
    logger.error('Please set the environment variables ALPACA_API_KEY and ALPACA_API_SECRET')
    raise
...
def download_historical_news(
    ...
    while next_page_token is not None:
        batch_of_news, next_page_token = fetch_batch_of_news(from_date, to_date, next_page_token)
    ...
    # save to file
    path_to_file = DATA_DIR / f'news_{from_date.strftime("%Y-%m-%d")}_{to_date.strftime("%Y-%m-%d")}.json'
